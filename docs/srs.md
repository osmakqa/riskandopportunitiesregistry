...
*   **Section User:**
    ...
    *   Access to a chronological **R&O List** with simplified reference IDs (e.g., R1, O1) and filters.
*   **Quality Assurance Auditor (Admin):**
    ...
    *   Access to global **R&O List** and Data Analysis Dashboard.
...
*   **Dashboard:** Section users must see a "Countdown" of upcoming target dates. Tables for "Open Risks" and "Open Opportunities" must be scrollable to conserve screen space.
*   **Analytics:**
    *   **QA** must have a global dashboard showing Total, Active, and Closed counts.
    *   **Section Users** must have a dashboard showing charts for their own section's Open vs. Closed items.
